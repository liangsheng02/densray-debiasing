...
\enote{sl}{Overall the debiasing performance of the three methods are comparable, with DensRay and Conceptor both having the best performance three times and hard-debiasing having the best performance 5 times.}
...
\enote{sl}{This conclusion is similar to the experiment from Bau et al (2018), which showed modifying some neurons activations in NMT didn't help in controlling gender, and conjectured that gender property is very distributed on the neurons.}
