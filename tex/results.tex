...
\begin{table}[h]
	...
	\caption{\tablabel{t:measure1}
		Examples for quantifying bias (model: bert-base). \enote{pd}{an example for a nice graphic that can be used as inspiration is https://arxiv.org/pdf/2010.00667.pdf Table 1}}
\end{table}
