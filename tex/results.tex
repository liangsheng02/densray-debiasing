...
In our opinion, multilingual debiasing involves two distinct
	...
	Chinese sentences are gender-neutral and German sentences
	cannot be gender-neutral (at least if wordy phrases like \textit{Studentinnen} and \textit{Studenten} are to be avoided). However, these particularities of surface form of individual
