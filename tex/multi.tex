...
Sanity check on the Chinese templates, where \textit{他} means \textit{he} and \textit{她} means \textit{she}. The two sentences are translated from \tabref{t:templates2}.}
\end{table*}