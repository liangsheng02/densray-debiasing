...
\enote{hs}{you probably have to help the reader recall what
  the log score was and that it can only be applied to an
  entire sentence, not to an indivdual token?}

\enote{hs}{what is the advantage of being able to measure
  bias on each token? you should at least give an example}
