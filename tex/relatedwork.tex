...
difficult to obtain a stable result on CEAT, since there are too much hyper-parameters need to be controlled, thus in this paper we  use WEAT and SEAT for our
