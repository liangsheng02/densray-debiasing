...
embeddings by \cite{karve2019conceptor}. In the experiments,
we found that hard debiasing adapted to all BERT layers
...
To construct OCCTMP, we start with 320 occupation names\footnote{https://github.com/tolga-/debiaswe/blob/master/data/professions.json} provided by \newcite{bolukbasi2016man}. Each occupation name is converted into the fromat ``[MASK] is an \textit{occupation}.''
