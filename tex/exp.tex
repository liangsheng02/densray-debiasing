...
of the Google analogy test set \shortcite{mikolov2013efficient}. As the input corpus, we collect text data from Wikipedia that contains 5,000 (resp.\ 10,000)
...
\enote{sl}{as far as I saw, all the association tests(IAT,WAET,SEAT,CEAT) use this hypothesis setup, I think it's just a 'tradition'.} 
