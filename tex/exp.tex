...
We use two evaluation datasets to measure gender bias: Association tests (Section~\ref{sec:weat}) and OCCTMP. \enote{sl}{ and OCCTMP (occupation templates).}
...
\enote{sl}{Since the deviation already exists in the data of these tasks, 
