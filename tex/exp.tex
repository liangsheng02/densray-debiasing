...
yields better results than only applying it to the last layer.\enote{pd}{I guess DensRay is also applied to all layers?} In contrast, when applying debiasing conceptor
