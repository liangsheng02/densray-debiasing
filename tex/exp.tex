...
Here we only apply DesnRay on one BERT layer at a time. We constructed a figure \figref{fig:layersbase} to illustrate the results of layers on our templates and the three WEAT categories.
\begin{figure}
	\centering
